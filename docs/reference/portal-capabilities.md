...
| 模拟与实盘 | `/live` | runtime、daemon、动态行情订阅、手工交易、部署、诊断、对账和 kill switch | `live_*、trading_*` | `/api/live、/api/trading` | CLI/API 等价；Portal 强化确认与观察 | [打开](../user/live-trading.md) | [查看](../assets/portal/live.png) |
